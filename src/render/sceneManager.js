...
class SceneManager {
    ...
    init() {
        ...
        // === НАЧАЛЬНАЯ ОРИЕНТАЦИЯ КАМЕРЫ (СТРОГО ВПЕРЕД ПО ОСИ Z) ===
        
        // Точка, куда смотрит камера (центр мира)
        this.controls.target.set(0, 0, 0); 
        
        // Камера стоит на оси Z, но смещена назад. 
        // Y = 0 означает, что она на уровне пола (не сверху).
        // Z = 150 означает, что она смотрит в сторону -Z (вглубь сцены).
